      ...
      <div className="page-content">
        <div className="row">
          <div className="col-6">
            ...
            <span>
              At Hippo Education, we believe that medical education should
              upgrade your practice and your life.
            </span>

            <span>
              This lifelong learning should be exciting, and something we look
              forward to. It should connect us to our fellow clinicians and
              remind us, as a community, why we practice medicine, not just how.
              We exist not only to change your practice, but to change your mind
              about what truly great education can achieve.
            </span>

            <span>
              If you want to swap CME that merely checks the boxes for a
              community of like-minded people learning, growing, and doing their
              best work together—welcome.You’ve found what you’re looking for.
            </span>
            ...
            <span>
              ...
              attention span, and humanity. Every piece of education we produce
              is made with intention for a consistently rewarding learning
              experience.
            </span>
            ...
            <span>
              ...
              convenient, tech-forward podcasts, video lectures, and articles,
              all on the go from your phone or tablet.
            </span>
          </div>
          <div className="col-6">
